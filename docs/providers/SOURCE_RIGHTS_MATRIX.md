...
| -------------------------------------- | ---------------------- | ------------------------------------------------------------------------------------------ | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| Repository fixtures                    | Fixture only           | `LOCAL_PASS` at `73297a6cfdc99b025990b001b39cef399f4d235e`; final-branch remote CI pending | Committed synthetic data                     | Deterministic excerpts and URLs clearly labeled example data                                                                                           | Ensure fixtures are synthetic/licensed and contain no customer data       |
