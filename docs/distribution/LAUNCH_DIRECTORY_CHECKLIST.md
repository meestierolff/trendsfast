# Launch directory checklist

Directories are optional distribution, not a reason to manufacture readiness.
Check current rules/fees/editorial requirements at submission time and avoid
paying for broad low-intent placement before cohort evidence.
...
- [ ] Free founder-reviewed scan terms/capacity; billing status.
- [ ] Tracked URL per channel with no private data.
- [ ] Removal/correction owner for stale claims and assets.
...
| Reddit communities          | founder problem or focused technical lesson           | manual, rules/mod approval, no automated ingestion   |
| X                           | founder story, demo, free scans                       | exact source status and capacity                     |

## Per-submission record

```text
Directory/channel:
Current rules checked at URL/date:
Owner:
Cost:
Canonical tracked URL/campaign:
Copy/assets version and release SHA:
Claims verified by:
Submitted/published URL and date:
Referral/submission outcome:
Correction/removal needed:
```
